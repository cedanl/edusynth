...
**edu-synth** is een Streamlit-applicatie die [SDV (Synthetic Data Vault)](https://github.com/sdv-dev/SDV) toegankelijk maakt voor data-analisten bij Nederlandse hogeronderwijsinstellingen.
...
2. **Genereren** — edu-synth traint een SDV Gaussian Copula model op jouw data en genereert een synthetische versie
...
edu-synth is een dunne laag. Alles wat de app doet, kun je ook direct met SDV:
